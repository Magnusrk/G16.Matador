...
public class Initializer {
    ...
    public static Field[] InitFields(){
        fields = new Field[]{
                ...
                new ShippingCompany("Helsingør - Helsingborg","Forsea" ,4000, new int[]{500, 1000, 2000, 4000}),
                ...
                new Brewery("Squash", 3000, new int[]{100,200}),
                ...
                new ShippingCompany("Aarhus-Odden","Molslinjen" ,4000, new int[]{500, 1000, 2000, 4000}),
